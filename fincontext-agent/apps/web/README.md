...
Note: This directory is named `apps/web/` in the repository for historical reasons. The actual content is a Gradio app, not a Next.js app. The previous Next.js + Cloudflare Pages plan was abandoned — see `docs/architecture.md`.
...
```
apps/web/   (rename to apps/demo-ui/ in your working directory)
...
git subtree push --prefix apps/web space main
```
